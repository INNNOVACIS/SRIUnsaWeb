...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'Remover',
        removeTitle: 'Borrar los archivos seleccionados',
        cancelLabel: 'Cancel',
        ...
        msgFilesTooMany: 'Número de archivos seleccionados para la carga <b>({n})</b> excede del límite máximo permitido <b>{m}</b>.',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Las restricciones de seguridad impiden la lectura del archivo "{name}".',
        ...
        msgImageResizeException: 'Error mientras redimensionamos la imagen.<pre>{errors}</pre>',
        dropZoneTitle: 'Drag & drop Archivos aqui &hellip;',
